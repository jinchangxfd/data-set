...
/* USER CODE BEGIN Header_StartRotationTask */
/**
* @brief Function implementing the ROTTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartRotationTask */
void StartRotationTask(void const * argument)
{
  /* USER CODE BEGIN StartRotationTask */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END StartRotationTask */
}
